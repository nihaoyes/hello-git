   ...
   implements IAdapterFactory
 {
   public Object getAdapter(Object adaptableObject, Class adapterType)
   {
     if (((adaptableObject instanceof IFile)) && 
       ...
       (adapterType == JavaProjectAdapter.class) && 
   ...
   private boolean isIbatorProject(IJavaProject project)
   {
     ...
     try
     {
       ...
       IClasspathEntry[] arrayOfIClasspathEntry1; int j = (arrayOfIClasspathEntry1 = classpath).length; for (int i = 0; i < j; i++) { IClasspathEntry iClasspathEntry = arrayOfIClasspathEntry1[i];
