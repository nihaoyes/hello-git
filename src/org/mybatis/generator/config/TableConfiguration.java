 ...
 public class TableConfiguration extends PropertyHolder implements Cloneable
 {
   ...
   public TableConfiguration(Context context)
   {
     ...
     this.columnOverrides = new java.util.ArrayList();
     this.ignoredColumns = new java.util.HashMap();
   ...
   public boolean isColumnIgnored(String columnName)
   {
     ...
     while (localIterator.hasNext()) {
       Map.Entry<IgnoredColumn, Boolean> entry = (Map.Entry)localIterator.next();
   ...
   public void validate(List<String> errors, int listPosition) {
     if (!StringUtility.stringHasValue(this.tableName)) {
       errors.add(org.mybatis.generator.internal.util.messages.Messages.getString(
     ...
     if (StringUtility.isTrue(getProperty("useColumnIndexes")))
     {
       ...
       if ((this.selectByExampleStatementEnabled) && 
         ...
         if (queryId1Set != queryId2Set) {
           errors.add(
             org.mybatis.generator.internal.util.messages.Messages.getString("ValidationError.13", fqTableName));
         }
       }
     }
