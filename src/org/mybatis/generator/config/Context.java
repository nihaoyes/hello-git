...
import org.mybatis.generator.internal.util.StringUtility;
   ...
   extends PropertyHolder
 {
   ...
   {
	   org.mybatis.generator.api.JavaTypeResolver javaTypeResolver;
     ...
     //每个表的 TableConfiguration 循环， 获取表内省数据
     ...
     throws InterruptedException
   {
     ...
     for (PluginConfiguration pluginConfiguration : this.pluginConfigurations) {
       ...
       if (plugin.validate(warnings)) {
         ...
         warnings.add(
           Messages.getString("Warning.24", pluginConfiguration.getConfigurationType(), this.id));
       }
     }
