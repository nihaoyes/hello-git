   ...
   extends AbstractXmlElementGenerator
 {
   ...
   {
     Iterator localIterator1 = this.introspectedTable.getPrimaryKeyColumns().iterator();
     ...
     localIterator1 = this.introspectedTable.getBaseColumns().iterator();
     while (localIterator1.hasNext()) {
       IntrospectedColumn introspectedColumn = (IntrospectedColumn)localIterator1.next();
   ...
   private void addResultMapConstructorElements(XmlElement answer)
   {
     ...
     localIterator = this.introspectedTable.getBaseColumns().iterator();
     while (localIterator.hasNext()) {
       IntrospectedColumn introspectedColumn = (IntrospectedColumn)localIterator.next();
