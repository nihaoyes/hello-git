   ...
   extends AbstractJavaGenerator
 {
   public List<CompilationUnit> getCompilationUnits()
   {
     ...
     Iterator localIterator = this.introspectedTable.getBLOBColumns().iterator();
   ...
   private void addParameterizedConstructor(TopLevelClass topLevelClass) {
     ...
     Iterator localIterator1 = this.introspectedTable.getAllColumns().iterator();
     ...
     localIterator2 = this.introspectedTable.getBLOBColumns().iterator();
     while (localIterator2.hasNext()) {
       IntrospectedColumn introspectedColumn = (IntrospectedColumn)localIterator2.next();
       sb.setLength(0);
       sb.append("this.");
