 ...
 public class IntrospectedColumn
 {
   ...
   public void setActualColumnName(String actualColumnName) {
     ...
     this.isColumnNameDelimited = 
       StringUtility.stringContainsSpace(actualColumnName);
   }
   ...
   {
     return (this.jdbcType == 1) || (this.jdbcType == 2005) || (this.jdbcType == -1) || (this.jdbcType == 12);
   }
   ...
   public boolean isJDBCDateColumn() {
     if (this.fullyQualifiedJavaType.equals(
       FullyQualifiedJavaType.getDateInstance())) {
       if ("DATE".equalsIgnoreCase(this.jdbcTypeName)) return true;
     }
     return 
   ...
   public boolean isJDBCTimeColumn() {
     if (this.fullyQualifiedJavaType.equals(
       FullyQualifiedJavaType.getDateInstance())) {
       if ("TIME".equalsIgnoreCase(this.jdbcTypeName)) return true;
     }
     return 
