 ...
 import ibator.util.TableVo.KeyInfo;
 ...
 public class SelectTableUI extends ActionGroup
 {
   ...
   public void getBoyGirl(String table) { new DBUtil();TableVo vo = DBUtil.getKeys(table);
   ...
   private void createSShell()
   {
     ...
     int old = 0;
     tv.addSelectionChangedListener(new org.eclipse.jface.viewers.ISelectionChangedListener()
     {
     ...
     final List data = DBUtil.getAllTable();
   ...
   private class OkAction extends Action {
     public OkAction() { setText(EclipseUI.getMessage("table_ok")); }
   ...
   private class SelectAllAction extends Action {
     public SelectAllAction() { setText(EclipseUI.getMessage("table_CheckAll")); }
