 ...
 {
   static { Activator.getDefault(); } private static String file = Activator.getDefault()
     .getStateLocation().toOSString() + 
     "/db.config.xml";
   static LocalDbConfig config = new LocalDbConfig(file);
   
   private static String projectName;
   List<DBVO> dbvos = ibator.util.DBUtil.getDb();
   ...
   private void createCboConfig() {
     ...
     this.cboConfig.addSelectionListener(new org.eclipse.swt.events.SelectionListener()
     {
   ...
   private void createCboDialect()
   {
     ...
     this.cboDialect.addSelectionListener(new SelectionAdapter()
     {
       public void widgetSelected(SelectionEvent e) {
   ...
   public void change()
   {
     this.cboConfig.addSelectionListener(new SelectionAdapter()
     {
       public void widgetSelected(SelectionEvent e) {
         EclipseDbConfig.this.temp = null;
         List<DBVO> list = EclipseDbConfig.config.readDbConfig();
