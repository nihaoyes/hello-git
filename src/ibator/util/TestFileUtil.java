 ...
 public class TestFileUtil
 {
   ...
   public static boolean createTestFileWithSpring(IProject project, String pojo, String filename)
   {
     ...
     sb.setLength(0);
     sb.append(Globar.pojoPath).append(".").append(pojo).append("Example");
     topLevelClass.addImportedType(sb.toString());
     ...
     topLevelClass.addImportedType("com.service." + tempServiceName);
     sb.setLength(0);
     sb.append(tempServiceName)
       .append(" service = (")
       .append(tempServiceName)
       .append(")context.getBean(\"")
       .append(Character.toLowerCase(tempServiceName.charAt(0)))
       .append(tempServiceName.substring(1))
       .append("\");");
     method.addBodyLine(sb.toString());
     ...
     sb.setLength(0);
     sb.append(pojo).append("Example").append(" example = new ").append(pojo).append("Example").append("();");
     method.addBodyLine(sb.toString());
     ...
     sb.setLength(0);
     sb.append("List<").append(pojo).append("> list = pageBean.getResultList();");
     method.addBodyLine(sb.toString());
